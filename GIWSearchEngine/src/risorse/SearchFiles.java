...
public class SearchFiles {
	...
	public static List<Document> search(String userQuery) throws IOException,
			ParseException {
		...
		ScoreDoc[] hits = doPagingSearch(in, searcher, query, hitsPerPage, raw,
...
//	}
	 ...
	 * 
	 */
	public static ScoreDoc[] doPagingSearch(BufferedReader in,
		...
		System.out.println(numTotalHits
				+ " total matching documents for query: " + query.toString());
