...
<div id="header">
    ...
    <form method="post" action="processaLinkLogin">
                <fieldset class="textbox">
            	<label class="query">
                <span>Cosa vuoi cercare</span>
                <input id="query" name="query" value="" type="text" autocomplete="on" placeholder="query">
                </label>
                <button class="submit button" type="submit">Ricerca</button>
                <!-- <input type="submit" value="Invia" name="submit" id="submit" /> -->
                <p>
                <a class="help" href="help.jsp">Guida su come utilizzare il motore di ricerca</a>
                </p>
